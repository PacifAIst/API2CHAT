...
3. Double-click `index.html` to open it in any modern browser and any OS (requires no PHP, no Python, no server running, nothing!).
...
5. (Optionally) To make sure all the data was erased click "Flush session".
